 <div class="well well-lg" style="height:400px;width: 700px">
        ...
        <div class="col-xs-offset-2">
            ...
            <div style="float: right">
                <button id="b1" style="height:20px;width: 20px"></button>
                <button id="b2" style="height:20px;width: 20px"></button>
                <button id=""b3 style="height:20px;width: 20px"></button>
                <button id="b4" style="height:20px;width: 20px"></button>
                <button id="b5" style="height:20px;width: 20px"></button>
